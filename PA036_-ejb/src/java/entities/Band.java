...
public class Band implements Serializable {
  ...
  @OneToMany(cascade = CascadeType.ALL, mappedBy = "bandid")
  private List<Bandgenres> bandgenresList;
  ...
  public Band(BigDecimal id, String bandname) {
    this.id = id;
  ...
  public String toString() {
    return "entities.Band[ id=" + id + " ]";
  }

  @XmlTransient
  public List<Bandgenres> getBandgenresList() {
    return bandgenresList;
  }

  public void setBandgenresList(List<Bandgenres> bandgenresList) {
    this.bandgenresList = bandgenresList;
  }
